...
############
v_fnn <- get_filenames(pattern="sdc-loss_0.01-wt_0.01-ro_10-*")
v.wt0.01 <- get_summary.mean(get_summary(v_fnn))[c(19,25,31,37),6]

v_fnn <- get_filenames(pattern="sdc-loss_0.01-wt_0.1-ro_10-*")
v.wt0.1 <- get_summary.mean(get_summary(v_fnn))[c(7,13),6]

v_fnn <- get_filenames(pattern="sdc-loss_0.01-wt_1-ro_10-*")
...
#####
v_fnn <- get_filenames(pattern="sdc-loss_0.005-wt_0.01-ro_10-*")
v.wt0.01 <- get_summary.mean(get_summary(v_fnn))[c(7,13),6]

v_fnn <- get_filenames(pattern="sdc-loss_0.005-wt_0.1-ro_10-*")
v.wt0.1 <- get_summary.mean(get_summary(v_fnn))[c(7,13),6]

v_fnn <- get_filenames(pattern="sdc-loss_0.005-wt_1-ro_10-*")
v.wt1 <- get_summary.mean(get_summary(v_fnn))[c(7,13),6]
...
#####
v_fnn <- get_filenames(pattern="sdc-loss_0.00-wt_0.01-ro_10-*")
v.wt0.01 <- get_summary.mean(get_summary(v_fnn))[c(7,13),6]

v_fnn <- get_filenames(pattern="sdc-loss_0.00-wt_0.1-ro_10-*")
v.wt0.1 <- get_summary.mean(get_summary(v_fnn))[c(7,13),6]

v_fnn <- get_filenames(pattern="sdc-loss_0.00-wt_1-ro_10-*")
v.wt1 <- get_summary.mean(get_summary(v_fnn))[c(7,13),6]
